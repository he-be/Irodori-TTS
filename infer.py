...
def main() -> None:
    ...
    # 12 sway steps on this branch, raised to 16 past 20 s of output by the runtime's
    # auto-step floor (docs/experiments/14-step-count.md). Pass --num-steps 40
    # --t-schedule-mode linear for the upstream default.
